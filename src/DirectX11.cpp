...
bool DirectX11::CreateDeviceD3D(HWND hwnd) {
    // Setup swap chain
...
void DirectX11::CleanupDeviceD3D() {
    CleanupRenderTarget();
...
void DirectX11::EndFrame() {
    ImGui::EndFrame();
    ImGui::Render();
    const float clear_color_with_alpha[4] = { 0, 0, 0, 255.f };
...
void DirectX11::CustomStyle() {
    ...
    style->Colors[ImGuiCol_CheckMark] = ImVec4(0.239215686917305f, 0.09803921729326248f, 0.800000011920929f, 1.0f);
    ...
    style->Colors[ImGuiCol_TabHovered] = ImVec4(0.239215686917305f, 0.09803921729326248f, 0.800000011920929f, 1.0f);
    style->Colors[ImGuiCol_TabActive] = ImVec4(0.239215686917305f, 0.09803921729326248f, 0.800000011920929f, 1.0f);
    style->Colors[ImGuiCol_TabUnfocused] = ImVec4(0.5665236115455627f, 0.3094074130058289f, 0.2528689205646515f, 1.0f);
